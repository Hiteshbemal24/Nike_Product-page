    ...
    <section
      ...
      >
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
          <p className="text-xl font-montserrat text-coral-red">Your <span className="font-bold text-black ">Favourite</span> Collections</p>
          <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[720px] max-sm:leading-[82] font-bold">
            <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">Discover Stylish</span>
            <br />
